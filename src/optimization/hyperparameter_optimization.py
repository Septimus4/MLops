...
class HyperparameterOptimizer:
    ...
    def optimize_logistic_regression(
        ...
        X: pd.DataFrame,
        y: pd.Series,
        study_name: str = "logistic_regression_optimization",
    ) -> Dict[str, Any]:
        """
        ...
        if self.mlflow:
            with self.mlflow.start_run(run_name="Logistic Regression Optimization"):
                ...
                self.mlflow.log_metrics(
                    {"best_cv_auc": study.best_value, "n_trials": len(study.trials)}
                )
    ...
    def optimize_lightgbm(
        self, X: pd.DataFrame, y: pd.Series, study_name: str = "lightgbm_optimization"
    ) -> Dict[str, Any]:
        """
    ...
    def optimize_xgboost(
        self, X: pd.DataFrame, y: pd.Series, study_name: str = "xgboost_optimization"
    ) -> Dict[str, Any]:
        """
    ...
    def optimize_mlp(
        self, X: pd.DataFrame, y: pd.Series, study_name: str = "mlp_optimization"
    ) -> Dict[str, Any]:
        """
